...
# --- 1. IMPORT YOUR NEW DATABASE HELPER ---
...
YOGA_SOLUTIONS = {
    "neck": {"tip": "Do 'Neck Rolls' to release tension.", "gif": "https://media.giphy.com/media/3o7TKsOXXsTXQ66I48/giphy.gif"},
    "back": {"tip": "Try 'Child Pose' for lower back relief.", "gif": "https://media.giphy.com/media/l41lYwm7CEHXnh2rg/giphy.gif"},
    "tired": {"tip": "A 'Seated Side Stretch' will wake you up.", "gif": "https://media.giphy.com/media/l41ldVq52d43l8Yq4/giphy.gif"},
    "stress": {"tip": "Sit straight and roll your shoulders back.", "gif": "https://media.giphy.com/media/1xVbRXc1wY5Jt6cOaN/giphy.gif"}
}
...
def home():
    if 'user_id' not in session:
        # Assign a random ID if not logged in (Guest Mode)
...
def chat():
    ...
    # --- 4. DETECT VISUAL TRIGGERS (Yoga/Breathing) ---
    show_yoga = False
    show_breathing = False
    yoga_data = {}
    
    # Simple Mood Logic for Database
    ...
    # Visual Triggers logic + Mood Update
    ...
    # --- 5. SAVE DATA TO MONGODB (Using New Helper) ---
    try:
        # Hum AI reply aane se pehle mood log kar rahe hain
        db_helper.add_mood(user_id, mood_score, emotion_label, user_message)
        print(f" Mood Logged: {emotion_label}")
